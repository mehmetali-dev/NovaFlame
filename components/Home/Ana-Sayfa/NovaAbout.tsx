...
<>
        ...
        <Head>
                ...
                <link rel="canonical" href="https://novasomine.com/#hakkimizda" />
        ...
        <section id='hakkimizda' className="py-24 relative xl:mr-0 lg:mr-5 mr-0">
        <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
            <div className="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1">
                <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                    <div className="w-full flex-col justify-center items-start gap-8 flex">
                        <div className="flex-col justify-start lg:items-start items-center gap-4 flex">
                            <h6 className="text-base font-semibold leading-7 text-gray-400">Nova Şömine</h6>
                            <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                                <h2
                                    className="text-orange-600 text-4xl font-bold font-manrope leading-normal lg:text-start text-center">
                                    Sıcak Başlangıçtan Güçlü Bir Geleceğe</h2>
                                <p
                                    className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                                    2001 yılında başlayan şömine yolculuğumuz, 2025 itibarıyla 10.000'den fazla imalat ve montaj deneyimiyle devam etmektedir. Geçen yıllarda kazandığımız tecrübeler, günümüz teknolojisiyle birleşerek yolumuzu aydınlatmaktadır. Odunlu şömine, barbekü, elektrikli şömine, ekmek fırınları ve biogazlı şömine çeşitlerimizle müşterilerimize kaliteli, güvenilir ve ekonomik hizmet sunmaya devam ediyoruz.</p>
                            </div>
                        </div>
                        <div className="w-full flex-col justify-center items-start gap-6 flex">
                            <div className="w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                <div
                                    ...
                                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">24+ Yıl</h4>
                                    <p className="text-gray-500 text-base font-normal leading-relaxed">Sektördeki Tecrübemizle Güven Sağlıyoruz</p>
                                </div>
                                <div
                                    className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">10.000+ Proje
                                    </h4>
                                    <p className="text-gray-500 text-base font-normal leading-relaxed">Mükemmelliği Başarıyla Gerçekleştirdik</p>
                                </div>
                            </div>
                            <div className="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                <div
                                    ...
                                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">15+ Ödül</h4>
                                    <p className="text-gray-500 text-base font-normal leading-relaxed">Yeniliğe Olan Bağlılığımız, Başarılarımızla Taçlandı</p>
                                </div>
                                <div
                                    className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">99% Memnun 
                                        Müşteri</h4>
                                    <p className="text-gray-500 text-base font-normal leading-relaxed">Müşteri Memnuniyetine Olan Odaklanmamızın Göstergesi</p>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  <a href="/iletisim" className="w-full h-full flex items-center justify-center">
    <span className="px-1.5 text-orange-500 text-sm font-medium leading-6 group-hover:-translate-x-0.5 transition-all duration-700 ease-in-out">
      İletişim
    </span>
    <svg className="group-hover:translate-x-0.5 transition-all duration-700 ease-in-out"
      xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M6.75265 4.49658L11.2528 8.99677L6.75 13.4996" stroke="#FF7F00" strokeWidth="1.6"
  ...
  <div className="sm:w-[564px] w-full sm:h-[646px] h-full sm:bg-gray-100 rounded-3xl sm:border border-gray-200 relative">
    <Image
      src="/arkaplantema2.jpeg"
      layout="fill"  // Resmin kapsayıcı div'e tamamen sığmasını sağlar
      objectFit="cover"  // Resmi tam olarak kapsayıcıya uydurur, kenarlardan kesilebilir
      alt="arkaplan"
      className="rounded-3xl"  // Kenarları yuvarlatır
    />
  </div>
</div>
