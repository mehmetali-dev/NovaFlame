                                ...
                                <div className="w-full flex-col justify-center items-start gap-6 flex">
                                    <div className="w-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                        <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                            ...
                                            <p className="text-gray-500 text-base font-normal leading-relaxed">
                                                Sektördeki Tecrübemizle Güven Sağlıyoruz
                                            </p>
                                        </div>
                                        <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                            <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">10.000+ Proje</h4>
                                            <p className="text-gray-500 text-base font-normal leading-relaxed">
                                                Mükemmelliği Başarıyla Gerçekleştirdik
                                            </p>
                                        </div>
                                    </div>
                                    <div className="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                                        <div className="w-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                            ...
                                            <p className="text-gray-500 text-base font-normal leading-relaxed">
                                                Yeniliğe Olan Bağlılığımız, Başarılarımızla Taçlandı
                                            </p>
                                        </div>
                                        <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                                            <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">99% Memnun Müşteri</h4>
                                            <p className="text-gray-500 text-base font-normal leading-relaxed">
                                                Müşteri Memnuniyetine Olan Odaklanmamızın Göstergesi
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <button className="sm:w-fit w-full group px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] transition-all duration-700 ease-in-out justify-center items-center flex">
                                <a href="/iletisim" className="w-full h-full flex items-center justify-center">
                                    ...
                                    <svg className="group-hover:translate-x-0.5 transition-all duration-700 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                        <path d="M6.75265 4.49658L11.2528 8.99677L6.75 13.4996" stroke="#FF7F00" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </a>
                            </button>
                        </div>
