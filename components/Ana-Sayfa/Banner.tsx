  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="keywords" content="Nova şömine, Gaziantep Şömine, Adana Şömine, Şanlıurfa Şömine, Hatay Şömine, Adıyaman Şömine, Güneydoğu Şömine, Elektrikli Şömine, Elektrikli Şömine Modelleri,Odunlu Şömine, Doğalgazlı Şömine, Bioetanol şömine, etanol şömine, Orta Şömineler, Şömine Hazneleri, dlc şömine, tektes şömine, şömine elektrikli, elektronik şömine, invicta şömine, şömine kazanı, flameline şömine, " />
...
<div className="w-full bg-white py-2 px-4 flex flex-wrap justify-between items-center text-gray-950">
  ...
  <div className="flex flex-row space-x-4 mb-2 md:mb-0 justify-center">
    ...
    <Link href="https://www.instagram.com/novasomine?igsh=MWNyN2dtODJ1Z3Exeg==" passHref>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48" className="social-icon hover:scale-110 transition-transform duration-300">
