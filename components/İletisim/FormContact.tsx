...
const Main = () => {
  const [hovered, setHovered] = useState(false); // Move useState inside the component
  ...
  return (
    ...
    <meta name="keywords" content="Gaziantep Şömine, Adana Şömine, Şanlıurfa Şömine, Hatay Şömine, Adıyaman Şömine, Güneydoğu Şömine, Elektrikli Şömine, Elektrikli Şömine Modelleri, elektrikli şömine üreticileri,  " />
    <link rel="canonical" href="https://novasomine.com/iletisim" />
    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Use grid for larger screens, flex for mobile */}
        <div className="grid lg:grid-cols-2 gap-24 flex-col-reverse sm:grid-cols-1">
          {/* Contact form */}
          <div className="lg:w-full w-full mb-10">
            ...
            <form action="" method="">
              ...
              ></textarea>
              <button className="w-full h-12 text-center text-white text-base font-semibold leading-6 rounded-full bg-[#F06B1C] shadow transition-all duration-700 hover:bg-[#f59c68]">
                Gönder
              </button>
            </form>
          </div>
          ...
          {/* Google Map iframe */}
          <div
            className="relative lg:max-w-xl w-full h-[600px] flex items-center justify-center bg-cover bg-no-repeat"
...
{!hovered && (
              <div className="relative z-10 rounded-xl bg-white">
                <div className="w-full sm:w-30 md:w-80 lg:w-96 h-auto bg-white shadow-xl p-4 sm:p-6 rounded-5xl">
                  <Image
                    src="/novasominelogo.webp"
                    alt="Nova Somine Logo"
                    className="mb-6 mx-auto"
                    width={164}
                    height={33}
                  />
                  <a href="tel:+905336929890" className="flex items-center mb-6">
                    <svg
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
                  ...
                  <a
                    href="mailto:info@novasomine.com"
      ...
      <a href="javascript:;" className="flex items-center mb-6">
        ...
        <h5 className="text-black text-base font-normal leading-6 ml-5">Fatih Mh. Maraşal Fevzi Çakmak Blv. No: 95</h5>
      </a>
      <div className="flex items-center justify-center border-t border-gray-100 pt-6">
                    <a href="https://www.facebook.com/share/2oG5jo6SfQHKLxbJ/?mibextid=LQQJ4d:;" className="mr-6">
                    ...
                    <a href="https://www.instagram.com/novasomine?igsh=MWNyN2dtODJ1Z3Exeg==:;" className="mr-6">
                      <svg width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
