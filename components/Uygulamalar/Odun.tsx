            ...
            <a href="#">
              <div className="relative">
                <Image
                  ...
                  src={`/galleryimg/${loc.img}`} // Görsel yolu burada düzeltilmiş
                  alt={loc.location}
                  width={400}
                  height={300}
                  onContextMenu={handleRightClick} // Sağ tıklama engelleme
                />
                {/* Logo Eklemek */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <Image
                    ...
                    alt="Logo"
                    width={100} // Logo boyutunu ihtiyaca göre ayarlayın
                    height={100}
                    className="opacity-100" // Şeffaflık
                  />
                </div>
              </div>
            </a>
      ...
      {imgPop && (
        <div className="fixed top-0 left-0 right-0 bottom-0 bg-black bg-opacity-85 z-50 flex justify-between items-center p-4">
          ...
          <div className="flex flex-col items-center">
            <Image
              src={`/galleryimg/${filteredData[selectedImg].img}`} // Görsel yolu burada düzeltilmiş
